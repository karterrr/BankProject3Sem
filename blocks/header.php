...
<div class="container py-3">
        <div class="d-flex flex-column flex-md-row align-items-center pb-3 mb-4 border-bottom">
            <a href="/index.php" class="d-flex align-items-center text-dark text-decoration-none">
                ...
                <span class="fs-4">Гачи Банк</span>
            </a>
            ...
            <nav class="menu d-inline-flex mt-2 mt-md-0 ms-md-auto">
                ...
                {
                    ?>
                    <a class="me-3 py-2 text-dark text-decoration-none" href="/index.php">Счета</a>
                    <a class="me-3 py-2 text-dark text-decoration-none" href="/index.php">История</a>
                    <a class="me-3 py-2 text-dark text-decoration-none" href="/index.php">Платежи</a>
                    <a class="me-3 py-2 text-dark text-decoration-none" href="/index.php">Диалоги</a>
